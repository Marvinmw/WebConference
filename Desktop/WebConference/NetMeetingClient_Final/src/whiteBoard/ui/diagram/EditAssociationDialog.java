...
import whiteBoard.model.Multiplicity;
import whiteBoard.model.UmlRelation;
import whiteBoard.model.Relation.ReadingDirection;
...
public class EditAssociationDialog extends javax.swing.JDialog implements Serializable{

  private Association association;

  /**
   * Creates new form EditAssociationDialog
   * @param board the parent frame
   * @param anAssociation the edited Association
   * @param modal whether the dialog is to be modal
   */
  public EditAssociationDialog(JPanel board, Association anAssociation,
    boolean modal) {
    super();
