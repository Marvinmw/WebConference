...
import whiteBoard.draw.MultiSelection;
import whiteBoard.draw.NullElement;
import whiteBoard.draw.NullSelection;
import whiteBoard.draw.RubberbandSelector;
 ...
 * @version 1.0
 */
public class SelectionHandler implements EditorMode , Serializable{
  ...
  public ContextMenuBuilder menubuilder = new ContextMenuBuilder();
