...
import whiteBoard.draw.LabelChangeListener;
import whiteBoard.model.UmlModel;
import whiteBoard.model.UmlModelImpl;
import whiteBoard.ui.commands.ModelReader;
import whiteBoard.ui.commands.ModelWriter;
import whiteBoard.ui.commands.PngExporter;
import whiteBoard.ui.commands.SvgExporter;
import whiteBoard.ui.diagram.DiagramEditor;
import whiteBoard.ui.diagram.EditorMouseEvent;
import whiteBoard.ui.diagram.EditorStateListener;
import whiteBoard.ui.diagram.SelectionListener;
...
import whiteBoard.util.MethodCall;
...
implements EditorStateListener, AppCommandListener, SelectionListener {
  ...
  public transient MainToolbarManager toolbarmanager;
  ...
  public Board() {
   ...
   // setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
    ...
    add(createEditorArea(), BorderLayout.CENTER);
  ...
  private void startClientNet() {
	   clientnet=new Client(currentEditor,staticToolbarManager,this);
		Thread t=new Thread(clientnet);
		t.start();
}
...
/**
 ...
 // }
  ...
  private JTabbedPane createEditorArea() {
    ...
    tabbedPane.setPreferredSize(new Dimension(660, 560));
    return tabbedPane;
  }
  ...
  private void createEditor(StructureDiagram diagram) {
    ...
    p.add(toolbar);
    p.add(toolbarmanager.getToolbar(), BorderLayout.WEST);
    editorPanel.add(spane, BorderLayout.CENTER);
    editorPanel.add(p, BorderLayout.NORTH);
