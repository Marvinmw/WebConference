 ...
 * @version 1.0
 */
public class DrawingContextImpl implements DrawingContext ,Serializable{
...
@Override
public void drawActor(double x, double y, double w, double h, Color fillColor) {
    ...
    double centery=y+h;
    g2d.draw(new Line2D.Double(centerx, centery, centerx, centery+1.5*h));
    g2d.draw(new Line2D.Double(centerx, centery+1.5*h, centerx-w/2, centery+2*h));
    g2d.draw(new Line2D.Double(centerx, centery+1.5*h, centerx+w/2, centery+2*h));
   g2d.draw(new Line2D.Double(centerx,  centery+1.5*h/2, centerx-w/4, centery+h));
   g2d.draw(new Line2D.Double(centerx,  centery+1.5*h/2, centerx+w/4, centery+h));
   // g2d.draw(new Line2D.Double(centerx,  centery+10, centerx-5, centery+15));
   // g2d.draw(new Line2D.Double (centerx,  centery+10, centerx+5, centery+15));
}

@Override
public void drawOval(double absoluteX1, double absoluteY1, double width,
		double height, Color fillColor) {
	g2d.setColor(fillColor);
	oval.setFrame(absoluteX1, absoluteY1, width, height);
	g2d.draw(oval);
