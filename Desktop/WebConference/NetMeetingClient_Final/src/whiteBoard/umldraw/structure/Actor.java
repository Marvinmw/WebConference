...
import whiteBoard.draw.AbstractCompositeNode;
import whiteBoard.draw.Compartment;
import whiteBoard.draw.DrawingContext;
import whiteBoard.draw.Label;
import whiteBoard.draw.LabelSource;
import whiteBoard.draw.SimpleLabel;
 ...
 * @version 1.0
 */
public final class Actor extends AbstractCompositeNode
implements LabelSource, UmlNode , Serializable{


  /**
	 * 
	 */
	private static final long serialVersionUID = -8218391669769705031L;
private static final double MIN_WIDTH = 5;
  ...
  private static Actor prototype = new Actor();

  /**
   * Returns the prototype instance.
   * @return the prototype instance
   */
  public static Actor getPrototype() { return prototype; }
  ...
  private void drawIcon(DrawingContext drawingContext) {
	    ...
	    double height = getSize().getHeight()/3;
	    drawingContext.drawActor(x, y, width, height, Color.BLACK);
