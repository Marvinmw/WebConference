 ...
 * @version 1.0
 */
public final class SystemBound extends AbstractCompositeNode
implements LabelSource, UmlNode , Serializable{
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 699785302437706939L;
/**
	 * 
	 */
...
private static final double MIN_WIDTH = 100;
  ...
  private static SystemBound prototype = new SystemBound();

  /**
   * Returns the prototype instance.
   * @return the prototype instance
   */
  public static SystemBound getPrototype() { return prototype; }
  ...
  @Override
  public Object clone() {
	  SystemBound cloned = (SystemBound) super.clone();
    if (component != null) {
