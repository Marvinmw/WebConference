...
import whiteBoard.ui.diagram.commands.AddNodeCommand;
 ...
 * @version 1.0
 */
public class CreationHandler implements EditorMode , Serializable{
  ...
  public void mousePressed(EditorMouseEvent event) {
    ...
    //double px=tmpPos.getX();
   // double py=tmpPos.getY();
