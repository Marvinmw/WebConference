 ...
 * @version 1.0
 */
public class EditorCommandDispatcher implements AppCommandListener , Serializable {
   ...
   */
  public EditorCommandDispatcher(Board aFrame) {
    this.frame = aFrame;
    initSelectorMap();
  }
  ...
  private void initSelectorMap() {
    ...
    selectorMap.put("CREATE_SYSTEMBOUND", new MethodCall(
  	        DiagramEditor.class.getMethod("setCreationMode", ElementType.class),
  	          ElementType.SYSTEMBOUND));
    
    selectorMap.put("CREATE_RECT", new MethodCall(
  	        DiagramEditor.class.getMethod("setCreationMode", ElementType.class),
  	          ElementType.RECT));
    
    selectorMap.put("CREATE_OVAL", new MethodCall(
  	        DiagramEditor.class.getMethod("setCreationMode", ElementType.class),
  	          ElementType.OVAL));
