 ...
 * @version 1.0
 */
public final class Oval extends AbstractCompositeNode
implements LabelSource, UmlNode , Serializable{
  ...
  private static Oval prototype = new Oval();

  /**
   * Returns the prototype instance.
   * @return the prototype instance
   */
  public static Oval getPrototype() { return prototype; }
  ...
  public void draw(DrawingContext drawingContext) {
   if (!isValid()) {
    ...
    mainCompartment.drawOval(drawingContext);
