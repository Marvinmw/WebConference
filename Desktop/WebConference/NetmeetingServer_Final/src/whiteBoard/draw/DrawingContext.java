 ...
 * @version 1.0
 */
public interface DrawingContext extends Serializable{
   ...
   * draw oval
   * */
  void drawActor(double x,double y,double w,double h, Color fillColor);
  /**
...
void drawOval(double absoluteX1, double absoluteY1, double width,
